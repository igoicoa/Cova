    ...
    public class BLReceta
    {
        ...
        public bool CrearReceta(BEReceta receta)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bitacora.GetInstance.RegistrarBitacora(new BEBitacora(DateTime.Now, Sesion.GetInstance.Usuario, TipoCriticidad.Info, "Se creo la Receta: " + ex.Message, "Crear Receta"));
        ...
        public bool ActualizarReceta(BEReceta receta)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bitacora.GetInstance.RegistrarBitacora(new BEBitacora(DateTime.Now, Sesion.GetInstance.Usuario, TipoCriticidad.Info, "Se actualizó la Receta: " + ex.Message, "Actualizar Receta"));
        ...
        public IList<BEReceta> BuscarRecetas(BEPaciente paciente)
        {
            ...
            catch (Exception ex)
            {
                ...
                Bitacora.GetInstance.RegistrarBitacora(new BEBitacora(DateTime.Now, Sesion.GetInstance.Usuario, TipoCriticidad.Info, "Se busco la Receta: " + ex.Message, "Buscar Receta"));
